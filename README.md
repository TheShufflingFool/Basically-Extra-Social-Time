...
2. Download the latest release of `ExtraBP_CS(1/2/3/4).p3a` ([here](https://github.com/TheShufflingFool/Basically-Extra-Social-Time/releases/latest)).
...
5. Move or copy `ExtraBP_CS(1/2/3/4).p3a` to the `mods` folder.
6. To uninstall, delete `ExtraBP_CS(1/2/3/4).p3a` from the `mods` folder.
